...
export default class TabBar extends Component<Props, State> {
  ...
  renderTab = (
    ...
    const { badge, badgeColor, label } = tab;
    const activeTextColor = this.props.activeTextColor || '#252C35';
    const inactiveTextColor = this.props.inactiveTextColor || '#ABB3B8';
